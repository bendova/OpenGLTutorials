...
namespace MyCode
{
	...
	void PointLighting::LoadPrograms()
	{
		mVertexLightingProgram = PointLightingProgramDataPtr(
			new PointLightingProgramData("VertexPointLighting.vert", "VertexPointLighting.frag"));

		mFragmentLightingProgram = PointLightingProgramDataPtr(
			new PointLightingProgramData("FragmentPointLighting.vert", "FragmentPointLighting.frag"));
	}
