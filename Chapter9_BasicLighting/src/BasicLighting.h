...
namespace MyCode
{
	...
	private:
		...
		void DrawWithLighting(glutil::MatrixStack& modelMatrix);
		...
		std::unique_ptr<ColorProgramData> mColorPD;
		std::unique_ptr<LightingProgramData> mWhiteDiffuseColorPD;
